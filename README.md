...
PM> Install-Package FolkerKinzel.VCards -Version 2.2.0

.NET CLI:
> dotnet add package FolkerKinzel.VCards --version 2.2.0

Package Reference (Visual Studio Project File):
<PackageReference Include="FolkerKinzel.VCards" Version="2.2.0" />

Paket CLI:
paket add FolkerKinzel.VCards --version 2.2.0

F# Interactive:
> #r "nuget: FolkerKinzel.VCards, 2.2.0"
```
