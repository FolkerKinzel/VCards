...
* [Download Project Reference English](https://github.com/FolkerKinzel/VCards/blob/master/ProjectReference/3.0.0-beta.1/FolkerKinzel.VCards.en.chm)

* [Projektdokumentation (Deutsch) herunterladen](https://github.com/FolkerKinzel/VCards/blob/master/ProjectReference/3.0.0-beta.1/FolkerKinzel.VCards.de.chm)
...
{
    /// <summary>
    /// Example implementation of FolkerKinzel.VCards.Models.ITimeZoneIDConverter to convert 
    /// IANA time zone names into UTC offsets in order to be compatible to older vCard clients 
    /// when writing vCard 2.1 or vCard 3.0.
