...
**C#**
``` C#
public IEnumerable<TextProperty?>? Languages { get; set; }
```
**VB**
``` VB
Public Property Languages As IEnumerable(Of TextProperty)
	Get
	Set
```
**C++**
``` C++
public:
property IEnumerable<TextProperty^>^ Languages {
...
**F#**
``` F#
member Languages : IEnumerable<TextProperty> with get, set
```
