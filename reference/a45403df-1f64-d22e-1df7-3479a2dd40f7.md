# OrderByIndex&lt;TSource&gt; Method


Sorts the elements in *values* ascending by the value of their <a href="70c82664-4c95-c20f-f819-7fba4087eead.md">Index</a> property.
...
``` VB
<ExtensionAttribute>
Public Shared Function OrderByIndex(Of TSource As VCardProperty) ( 
...
where TSource : VCardProperty
static IEnumerable<TSource>^ OrderByIndex(
...
#### Parameters
<dl><dt>  <a href="https://learn.microsoft.com/dotnet/api/system.collections.generic.ienumerable-1" target="_blank" rel="noopener noreferrer">IEnumerable</a>(TSource)</dt><dd>The <a href="https://learn.microsoft.com/dotnet/api/system.collections.generic.ienumerable-1" target="_blank" rel="noopener noreferrer">IEnumerable(T)</a> of <a href="e1395eb9-792c-c4d8-ee22-97939a91c58e.md">VCardProperty</a> objects to sort. The collection may be <code>null</code>, empty, or may contain <code>null</code> values.</dd><dt>  <a href="https://learn.microsoft.com/dotnet/api/system.boolean" target="_blank" rel="noopener noreferrer">Boolean</a>  (Optional)</dt><dd>Pass <code>false</code> to include empty items in the return value. ("Empty" means that <a href="2a29e617-7cc7-2352-75f6-ea22e96afdc3.md">IsEmpty</a> returns <code>true</code>.) <code>null</code> references are removed in any case.</dd></dl>
...
A collection that contains the items of *values* ordered ascending by the value of their <a href="70c82664-4c95-c20f-f819-7fba4087eead.md">Index</a> property. If the <a href="70c82664-4c95-c20f-f819-7fba4087eead.md">Index</a> property is `null`, <a href="https://learn.microsoft.com/dotnet/api/system.int32.maxvalue" target="_blank" rel="noopener noreferrer">MaxValue</a> is assumed.

The returned collection won't contain `null` references. If *values* is `null`, an empty collection will be returned.
