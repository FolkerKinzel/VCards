# Add(Guid, Nullable&lt;Rel&gt;, Action&lt;ParameterSection&gt;, Func&lt;VCard, String&gt;) Method


Adds a <a href="fafb9a2d-3fc2-1db2-dd49-90299dc5fc8e.md">RelationProperty</a> instance, which is newly initialized using a <a href="https://learn.microsoft.com/dotnet/api/system.guid" target="_blank" rel="noopener noreferrer">Guid</a> that refers to the vCard of the person or organization via its <a href="5913b05b-0099-90a2-2736-25ace1bce6f9.md">ID</a> property (`UID`), to the specified property of the <a href="3e2b7a12-e0a3-230d-01ba-69b9f3ec3464.md">VCard</a>.
