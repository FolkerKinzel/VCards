...
**C#**
``` C#
public AddressBuilder Addresses { get; }
```
**VB**
``` VB
Public ReadOnly Property Addresses As AddressBuilder
	Get
```
**C++**
``` C++
public:
property AddressBuilder Addresses {
	AddressBuilder get ();
}
```
**F#**
``` F#
member Addresses : AddressBuilder with get
```



#### Property Value
<a href="e57e01d0-9d4b-8d5d-38d2-4f3e4ddd509f.md">AddressBuilder</a>
