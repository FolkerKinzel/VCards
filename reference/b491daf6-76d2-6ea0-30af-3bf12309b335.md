...
#### Parameters
<dl><dt>  <a href="https://learn.microsoft.com/dotnet/api/system.uri" target="_blank" rel="noopener noreferrer">Uri</a></dt><dd>An absolute <a href="https://learn.microsoft.com/dotnet/api/system.uri" target="_blank" rel="noopener noreferrer">Uri</a> that serves as global identifier of the executing application, or <code>null</code> to disable global synchronization. (The <a href="https://learn.microsoft.com/dotnet/api/system.uri" target="_blank" rel="noopener noreferrer">Uri</a> should be unique: UUID-URNs, e.g., are well suited.)</dd></dl>

## Remarks

The registration of the executing application is a technical requirement for the global data synchronization mechanism introduced with vCard 4.0. Call this method once at the startup of the application: It's not allowed to register different <a href="https://learn.microsoft.com/dotnet/api/system.uri" target="_blank" rel="noopener noreferrer">Uri</a>s within a single application.

The method sets the static property <a href="c69124af-6358-4421-a6c7-c3a2cd619ef3.md">App</a>.

Although it is allowed to call this method with the `null` argument, this is not recommended. (UUID-URNs are ideal for the task.) Call the method before any other method of the library and only once in the lifetime of your application. The URI should be the same everytime the application runs.
...
<td><em>globalID</em> is not an absolute <a href="https://learn.microsoft.com/dotnet/api/system.uri" target="_blank" rel="noopener noreferrer">Uri</a>.</td></tr>
<tr>
<td><a href="https://learn.microsoft.com/dotnet/api/system.invalidoperationexception" target="_blank" rel="noopener noreferrer">InvalidOperationException</a></td>
<td><p>An attempt was made to register different <a href="https://learn.microsoft.com/dotnet/api/system.uri" target="_blank" rel="noopener noreferrer">Uri</a>s</p><p>- or -</p><p>

the <a href="23413828-9a4a-2851-b88b-84d0afcb0031.md">VCard</a> class had been used before this method has been called.</p></td></tr>
</table>
...
<a href="c69124af-6358-4421-a6c7-c3a2cd619ef3.md">App</a>  
