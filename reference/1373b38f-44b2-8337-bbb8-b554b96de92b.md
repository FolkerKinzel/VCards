...
**VB**
``` VB
Public ReadOnly Property Suffixes As ReadOnlyCollection(Of String)
	Get
```
**C++**
``` C++
public:
property ReadOnlyCollection<String^>^ Suffixes {
	ReadOnlyCollection<String^>^ get ();
}
```
**F#**
``` F#
member Suffixes : ReadOnlyCollection<string> with get
```
