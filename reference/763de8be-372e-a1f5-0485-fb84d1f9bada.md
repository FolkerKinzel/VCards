...
**C#**
``` C#
public DateAndOrTimeBuilder AnniversaryViews { get; }
```
**VB**
``` VB
Public ReadOnly Property AnniversaryViews As DateAndOrTimeBuilder
	Get
```
**C++**
``` C++
public:
property DateAndOrTimeBuilder AnniversaryViews {
	DateAndOrTimeBuilder get ();
}
```
**F#**
``` F#
member AnniversaryViews : DateAndOrTimeBuilder with get
```
