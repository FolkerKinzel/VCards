...
**C#**
``` C#
public GenderBuilder GenderViews { get; }
```
**VB**
``` VB
Public ReadOnly Property GenderViews As GenderBuilder
	Get
```
**C++**
``` C++
public:
property GenderBuilder GenderViews {
	GenderBuilder get ();
}
```
**F#**
``` F#
member GenderViews : GenderBuilder with get
```



#### Property Value
<a href="88475522-6d79-c5cb-b17a-3917be32c65a.md">GenderBuilder</a>
