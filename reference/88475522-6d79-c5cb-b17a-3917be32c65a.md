# GenderBuilder Structure


Provides methods for editing the <a href="b3545d4e-d8e7-ae7b-4a5c-65ca19e48d69.md">GenderViews</a> property.
...
**VB**
``` VB
Public Structure GenderBuilder
```
**C++**
``` C++
public value class GenderBuilder
```
**F#**
``` F#
[<SealedAttribute>]
...
<table><tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  <a href="https://learn.microsoft.com/dotnet/api/system.valuetype" target="_blank" rel="noopener noreferrer">ValueType</a>  →  GenderBuilder</td></tr>
</table>
