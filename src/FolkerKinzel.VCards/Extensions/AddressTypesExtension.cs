...
/// <summary>Extension methods that make working with the <see cref="AddressTypes" /> 
/// enum easier.</summary>
public static class AddressTypesExtension
{
    ...
    /// /> are added.</param>
    /// <param name="flags">A single <see cref="AddressTypes" /> value or a combination
    /// of several <see cref="AddressTypes" /> values.</param>
