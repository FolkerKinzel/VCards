...
/// <summary>Extension methods that make working with the <see cref="Addr" /> 
/// enum easier.</summary>
public static class AddrExtension
{
    ...
    /// /> are added.</param>
    /// <param name="flags">A single <see cref="Addr" /> value or a combination
    /// of several <see cref="Addr" /> values.</param>
    ...
    [return: NotNull]
    public static Addr? Set(this Addr? value, Addr flags)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsSet(this Addr? value, Addr flags)
        => (value & flags) == flags;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Addr? Unset(this Addr? value, Addr flags)
    {
        value &= ~flags;
        return value == (Addr)0 ? null : value;
    }
}
