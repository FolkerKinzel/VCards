...
/// <summary>Extension methods that make working with the <see cref="Tel" />
/// enum easier.</summary>
public static class TelExtension
{
    ...
    /// /> are added.</param>
    /// <param name="flags">A single <see cref="Tel" /> value or a combination
    /// of several <see cref="Tel" /> values.</param>
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Tel? Unset(this Tel? value, Tel flags)
    {
        value &= ~flags;
        return value == (Tel)0 ? null : value;
    }
}
