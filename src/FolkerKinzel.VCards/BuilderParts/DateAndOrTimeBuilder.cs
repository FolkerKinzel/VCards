...
public readonly struct DateAndOrTimeBuilder
{
    ...
    /// <summary>
    /// Adds a <see cref="DateAndOrTimeProperty"/> instance, which is newly 
    /// initialized from a <see cref="System.DateTime"/> or
    /// <see cref="DateTimeOffset"/> value, to the specified property of the <see cref="VCardBuilder.VCard"/>.
    /// </summary>
    ...
    /// <summary>
    /// Adds a <see cref="DateAndOrTimeProperty"/> instance, which is newly 
    /// initialized from a <see cref="TimeOnly"/> value, to the specified property of the <see cref="VCardBuilder.VCard"/>.
    /// </summary>
