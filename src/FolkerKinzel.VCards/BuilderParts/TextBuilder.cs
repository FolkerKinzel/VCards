...
public readonly struct TextBuilder
{
    ...
    /// <param name="pref">Pass <c>true</c> to give the newly created <see cref="VCardProperty"/> the highest
    /// preference <c>(1)</c> and to downgrade the other instances in the collection.</param>
