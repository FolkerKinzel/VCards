...
public sealed partial class VCardBuilder
{
    ...
    {
        _vCard.DeathDateViews = Add(DateAndOrTimeProperty.FromDate(year, month, day, group),
    ...
    {
        _vCard.DeathDateViews = Add(DateAndOrTimeProperty.FromDate(date, group),
                                              _vCard.DeathDateViews,
                                              parameters,
                                              false);
        return this;
    ...
    {
        _vCard.DeathDateViews = Add(DateAndOrTimeProperty.FromDateTime(dateTime, group),
                                              _vCard.DeathDateViews,
                                              parameters,
                                              false);
        return this;
