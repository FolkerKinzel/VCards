...
public class GenderPropertyTests
{
    ...
    {
        var genderProp = new GenderProperty(Gender.Create(expectedSex, expectedGenderIdentity), expectedGroup);
    ...
    {
        var prop = new GenderProperty(Gender.Create(Sex.Female, IDENTITY), GROUP);
    ...
    {
        var prop1 = new GenderProperty(Gender.Create(Sex.Other, "difficult"));
