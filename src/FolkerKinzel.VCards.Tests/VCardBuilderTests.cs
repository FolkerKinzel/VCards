...
public class VCardBuilderTests
{
    ...
    public void AddAddressTest1()
    {
        ...
        Assert.Contains(x => x?.Value.Street[0] == "3", vc.Addresses);
        VCardBuilder.Create(vc).Addresses.Remove(x => x.Value.Street[0] == "3");
        Assert.DoesNotContain(x => x?.Value.Street[0] == "3", vc.Addresses);
    ...
    public void AddAnniversaryViewTest()
    {
        ...
        Assert.HasCount(1, vc.AnniversaryViews);
    ...
    public void AddBirthDayViewTest1()
    {
        ...
        Assert.HasCount(1, vc.BirthDayViews);
    }
    ...
    public void AddBirthDayViewTest3()
    {
        ...
        Assert.IsNotNull(vc.BirthDayViews);
        Assert.HasCount(4, vc.BirthDayViews);
    ...
    [TestMethod()]
    public void AddBirthDayViewTest4()
    {
        VCard vc = VCardBuilder
            .Create()
            .BirthDayViews.Add(-42, 42)
            .VCard;

        DateAndOrTimeProperty? bDay = vc.BirthDayViews.FirstOrNull(skipEmptyItems: false);
        Assert.IsNotNull(bDay);
        Assert.IsTrue(bDay.IsEmpty);
    }

    [TestMethod()]
    public void AddBirthDayViewTest5()
    {
        VCard vc = VCardBuilder
            .Create()
            .BirthDayViews.Add(int.MinValue, -42, 42)
            .VCard;
    ...
    public void AddBirthPlaceViewTest()
    {
        ...
        Assert.IsNotNull(vc.BirthPlaceViews);
        Assert.HasCount(1, vc.BirthPlaceViews);
    ...
    public void AddCalendarAddressTest1()
    {
        ...
        Assert.HasCount(1, vc.CalendarAddresses);
    ...
    public void AddCalendarUserAddressTest()
    {
        ...
        Assert.HasCount(1, vc.CalendarUserAddresses);
    }
    ...
    public void AddCategoryTest1()
    {
        ...
        Assert.HasCount(2, vc.Categories);
        ...
        Assert.IsNotNull(vc.Categories);
        Assert.HasCount(1, vc.Categories);
    ...
    public void AddDeathDateViewTest()
    {
        ...
        Assert.HasCount(1, vc.DeathDateViews);
    }
    ...
    public void AddDeathPlaceViewTest()
    {
        ...
        Assert.HasCount(1, vc.DeathPlaceViews);
    }
    ...
    public void AddDisplayNameTest()
    {
        ...
        Assert.HasCount(1, vc.DisplayNames);
    }
    ...
    public void AddExpertiseTest()
    {
        ...
        Assert.HasCount(1, vc.Expertises);
    }
    ...
    public void AddFreeOrBusyUrlTest()
    {
        ...
        Assert.HasCount(1, vc.FreeOrBusyUrls);
    }
    ...
    public void AddGenderViewTest()
    {
        ...
        Assert.HasCount(2, vc.GenderViews);
    ...
    public void AddGeoCoordinateTest1()
    {
        ...
        Assert.HasCount(1, vc.GeoCoordinates);
        ...
        Assert.IsNotNull(vc.GeoCoordinates);
        Assert.IsEmpty(vc.GeoCoordinates);
    ...
    public void AddGeoCoordinateTest4()
    {
        ...
        Assert.IsNotNull(vc.GeoCoordinates);
        Assert.HasCount(1, vc.GeoCoordinates);
        Assert.IsNull(vc.GeoCoordinates.First()!.Group);
    }
    ...
    public void AddGramGendersTest1()
    {
        ...
        Assert.HasCount(1, vc.GramGenders);
    }
    ...
    [TestMethod]
    public void AddGramGendersTest4()
    {
        VCard vc = VCardBuilder
            .Create()
            .GramGenders.Add(Gram.Neuter)
            .GramGenders.Add(Gram.Common)
            .VCard;

        Assert.IsNotNull(vc.GramGenders);
        Assert.IsTrue(vc.GramGenders.OfType<GramProperty>().All(x => x.Parameters.Preference == 100));

        VCardBuilder.Create(vc).GramGenders.SetPreferences();

        Assert.IsNotNull(vc.GramGenders);
        Assert.IsTrue(vc.GramGenders.OfType<GramProperty>().All(x => x.Parameters.Preference < 100));

        VCardBuilder.Create(vc).GramGenders.UnsetPreferences();
    ...
    [TestMethod]
    public void AddGramGendersTest5()
    {
        VCard vc = VCardBuilder
            .Create()
            .GramGenders.Add(Gram.Neuter)
        ...
        Assert.IsNotNull(vc.GramGenders);
        Assert.IsTrue(vc.GramGenders.OfType<GramProperty>().All(x => !x.Parameters.Index.HasValue));

        VCardBuilder.Create(vc).GramGenders.SetIndexes();

        Assert.IsNotNull(vc.GramGenders);
        Assert.IsTrue(vc.GramGenders.OfType<GramProperty>().All(x => x.Parameters.Index.HasValue));

        VCardBuilder.Create(vc).GramGenders.UnsetIndexes();
    ...
    [TestMethod]
    public void EditGramGendersTest2()
    {
        var vc = new VCard();
        Assert.IsNull(vc.GramGenders);

        VCardBuilder.Create(vc).GramGenders.Edit((props, b) => [], true);
    ...
    public void AddHobbyTest()
    {
        ...
        Assert.HasCount(1, vc.Hobbies);
    }

    [TestMethod()]
    public void SetContactIDTest1()
    {
        VCard vc = VCardBuilder
            .Create()
    ...
    [TestMethod]
    public void SetContactIDTest5()
    {
        var vc = new VCard(setContactID: false);
        Assert.IsNull(vc.ContactID);

        var builder = VCardBuilder.Create(vc);
        builder.ContactID.Set((ContactID?)null);
        Assert.IsNotNull(vc.ContactID);
        Assert.IsTrue(vc.ContactID.IsEmpty);

        vc.ContactID = null;

        builder.ContactID.Set((Uri?)null);
        Assert.IsNotNull(vc.ContactID);
        Assert.IsTrue(vc.ContactID.IsEmpty);

        vc.ContactID = null;

        builder.ContactID.Set((string?)null);
        Assert.IsNotNull(vc.ContactID);
        Assert.IsTrue(vc.ContactID.IsEmpty);
    }
    ...
    public void AddMessengerTest()
    {
        ...
        Assert.HasCount(1, vc.Messengers);
    }
    ...
    public void AddInterestTest()
    {
        ...
        Assert.HasCount(1, vc.Interests);
    }
    ...
    public void AddLanguageTest()
    {
        ...
        Assert.HasCount(1, vc.SpokenLanguages);
    }
    ...
    public void AddNameViewTest3()
    {
        ...
        Assert.HasCount(3, vc.NameViews);
        builder.NameViews.Remove(x => x.Value.Given.FirstOrDefault() == "Miller");

        Assert.HasCount(2, vc.NameViews);
        builder.NameViews.Clear();
    ...
    [TestMethod()]
    public void AddNonStandardTest1()
    {
        VCard vc = VCardBuilder
            .Create()
        ...
        Assert.HasCount(2, vc.NonStandards);
        ...
        Assert.IsNotNull(vc.NonStandards);
        Assert.HasCount(1, vc.NonStandards);
    ...
    [TestMethod]
    public void AddNonStandardTest2()
    {
        VCard vc = VCardBuilder
            .Create()
            .NonStandards.Add("invalid", "first")
            .VCard;

        NonStandardProperty? first = vc.NonStandards.FirstOrNull(skipEmptyItems: false);
        Assert.IsNotNull(first);
    ...
    public void AddOrganizationTest()
    {
        ...
        Assert.IsNotNull(vc.Organizations);
        Assert.HasCount(1, vc.Organizations);
    ...
    public void AddOrgDirectoryTest()
    {
        ...
        Assert.HasCount(1, vc.OrgDirectories);
    }
    ...
    public void AddPhotoTest2()
    {
        ...
        DataProperty? first = vc.Photos.FirstOrNull(skipEmptyItems: false);
        Assert.IsNotNull(first);
        Assert.IsTrue(first.IsEmpty);
    }
    ...
    public void AddRelationTest1()
    {
        ...
        Assert.IsNotNull(vc.Relations);
        Assert.HasCount(1, vc.Relations);
    ...
    public void AddSocialMediaProfileTest()
    {
        ...
        Assert.HasCount(1, vc.SocialMediaProfiles);
    }
    ...
    public void AddTimeZoneTest1()
    {
        ...
        Assert.HasCount(1, vc.TimeZones);
