...
public class EmbeddedBytesPropertyTests
{
    ...
    public void EmbeddedBytesPropertyTest1()
    {
        ...
        Assert.IsInstanceOfType(prop.Value.Object, typeof(byte[]));
    ...
    public void CloneTest1()
    {
        ...
        Assert.IsInstanceOfType(prop1.Value.Object, typeof(byte[]));
        Assert.IsInstanceOfType(prop2.Value.Object, typeof(byte[]));
