...
public class MimeTypeConverterNewTests
{
    ...
    {
        string? result = MimeTypeConverterNew.ImageTypeValueFromMimeType(input);
    ...
    {
        string result = MimeTypeConverterNew.MimeTypeFromEncryptionTypeValue(typeValue);
    ...
    {
        string? result = MimeTypeConverterNew.KeyTypeValueFromMimeType(mime);
    ...
    {
        string result = MimeTypeConverterNew.MimeTypeFromImageTypeValue(typeValue);
        Assert.AreEqual(mime, result);
    }
