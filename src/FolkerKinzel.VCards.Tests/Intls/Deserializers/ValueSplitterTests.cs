...
public class ValueSplitterTests
{
    ...
    public void SplitTest1(string? valueString, char splitChar, StringSplitOptions options, int expectedParts)
    {
        ...
        IEnumerable<string> valueSplitter = ValueSplitter.Split(valueString.AsMemory(), splitChar, options, false, Enums.VCdVersion.V4_0);
    ...
    {
        IEnumerable<string> valueSplitter = ValueSplitter.Split(valueString.AsMemory(), splitChar, StringSplitOptions.None, false, Enums.VCdVersion.V3_0);
    ...
    {
        IEnumerable<string> splitter = ValueSplitter.Split(",,,".AsMemory(), ',', StringSplitOptions.RemoveEmptyEntries, false, Enums.VCdVersion.V2_1);
    ...
    {
        IEnumerable<string> splitter = ValueSplitter.Split("abc".AsMemory(), ',', StringSplitOptions.None, false, Enums.VCdVersion.V4_0);
