...
Encapsulates information that is used to identify a vCard client globally, and locally inside the <a href="23413828-9a4a-2851-b88b-84d0afcb0031.md">VCard</a>
...
**C#**
``` C#
public sealed class AppIDProperty : VCardProperty, 
	IEnumerable<AppIDProperty>, IEnumerable
```
**VB**
``` VB
Public NotInheritable Class AppIDProperty
	Inherits VCardProperty
	Implements IEnumerable(Of AppIDProperty), IEnumerable
```
**C++**
``` C++
public ref class AppIDProperty sealed : public VCardProperty, 
	IEnumerable<AppIDProperty^>, IEnumerable
```
**F#**
``` F#
...
type AppIDProperty = 
    class
        ...
        interface IEnumerable<AppIDProperty>
        interface IEnumerable
    end
```

<table><tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  <a href="e1395eb9-792c-c4d8-ee22-97939a91c58e.md">VCardProperty</a>  →  AppIDProperty</td></tr>
<tr><td><strong>Implements</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.collections.generic.ienumerable-1" target="_blank" rel="noopener noreferrer">IEnumerable</a>(AppIDProperty), <a href="https://learn.microsoft.com/dotnet/api/system.collections.ienumerable" target="_blank" rel="noopener noreferrer">IEnumerable</a></td></tr>
</table>
...
<td>The data provided by the AppIDProperty.</td></tr>
</table>
