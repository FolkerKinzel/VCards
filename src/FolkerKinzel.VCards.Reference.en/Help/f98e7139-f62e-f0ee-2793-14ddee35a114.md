...
**VB**
``` VB
Public ReadOnly Property PostalCode As ReadOnlyCollection(Of String)
	Get
```
**C++**
``` C++
public:
property ReadOnlyCollection<String^>^ PostalCode {
	ReadOnlyCollection<String^>^ get ();
}
```
**F#**
``` F#
member PostalCode : ReadOnlyCollection<string> with get
```
