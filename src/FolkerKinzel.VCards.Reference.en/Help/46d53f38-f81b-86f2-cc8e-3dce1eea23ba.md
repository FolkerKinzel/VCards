...
**C#**
``` C#
public NameBuilder NameViews { get; }
```
**VB**
``` VB
Public ReadOnly Property NameViews As NameBuilder
	Get
```
**C++**
``` C++
public:
property NameBuilder NameViews {
	NameBuilder get ();
}
```
**F#**
``` F#
member NameViews : NameBuilder with get
```



#### Property Value
<a href="8aff507c-c7cd-5e33-59aa-8d4b140efaf7.md">NameBuilder</a>
