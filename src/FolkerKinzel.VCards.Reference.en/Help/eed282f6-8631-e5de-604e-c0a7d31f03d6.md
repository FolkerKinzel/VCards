...
**C#**
``` C#
public OrgBuilder Organizations { get; }
```
**VB**
``` VB
Public ReadOnly Property Organizations As OrgBuilder
	Get
```
**C++**
``` C++
public:
property OrgBuilder Organizations {
	OrgBuilder get ();
}
```
**F#**
``` F#
member Organizations : OrgBuilder with get
```



#### Property Value
<a href="1d4ae0a4-42d3-48a9-5141-153356099ecd.md">OrgBuilder</a>
