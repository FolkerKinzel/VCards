...
**C#**
``` C#
public RelationBuilder Relations { get; }
```
**VB**
``` VB
Public ReadOnly Property Relations As RelationBuilder
	Get
```
**C++**
``` C++
public:
property RelationBuilder Relations {
	RelationBuilder get ();
}
```
**F#**
``` F#
member Relations : RelationBuilder with get
```
