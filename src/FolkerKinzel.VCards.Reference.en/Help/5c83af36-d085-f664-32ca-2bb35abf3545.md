# ConcatWith&lt;TSource&gt; Method


Concatenates two sequences of <a href="e1395eb9-792c-c4d8-ee22-97939a91c58e.md">VCardProperty</a> objects. (Most <a href="e1395eb9-792c-c4d8-ee22-97939a91c58e.md">VCardProperty</a> ojects implement <a href="https://learn.microsoft.com/dotnet/api/system.collections.generic.ienumerable-1" target="_blank" rel="noopener noreferrer">IEnumerable&lt;VCardPoperty&gt;</a> and are themselves such a sequence.)
...
#### Parameters
<dl><dt>  <a href="https://learn.microsoft.com/dotnet/api/system.collections.generic.ienumerable-1" target="_blank" rel="noopener noreferrer">IEnumerable</a>(TSource)</dt><dd>The first sequence (or <a href="e1395eb9-792c-c4d8-ee22-97939a91c58e.md">VCardProperty</a> object) to concatenate or <code>null</code>.</dd><dt>  <a href="https://learn.microsoft.com/dotnet/api/system.collections.generic.ienumerable-1" target="_blank" rel="noopener noreferrer">IEnumerable</a>(TSource)</dt><dd>The second sequence (or <a href="e1395eb9-792c-c4d8-ee22-97939a91c58e.md">VCardProperty</a> object) to concatenate or <code>null</code>.</dd></dl>
...
An <a href="https://learn.microsoft.com/dotnet/api/system.collections.generic.ienumerable-1" target="_blank" rel="noopener noreferrer">IEnumerable(T)</a> that contains the concatenated elements of the two input sequences that are not null, or an empty collection if no such elements could be found.
...
## Remarks
The method works similar to <a href="https://learn.microsoft.com/dotnet/api/system.linq.enumerable.concat" target="_blank" rel="noopener noreferrer">Concat(TSource)(IEnumerable(TSource), IEnumerable(TSource))</a> but differs in that it can be called on `null` references and in that it accepts `null` references as argument.
