...
**C#**
``` C#
public DateAndOrTimeBuilder BirthDayViews { get; }
```
**VB**
``` VB
Public ReadOnly Property BirthDayViews As DateAndOrTimeBuilder
	Get
```
**C++**
``` C++
public:
property DateAndOrTimeBuilder BirthDayViews {
	DateAndOrTimeBuilder get ();
}
```
**F#**
``` F#
member BirthDayViews : DateAndOrTimeBuilder with get
```
