...
Encapsulates data from vCard properties which describe relationships with other people.
...
public abstract class RelationProperty : VCardProperty, 
	IEnumerable<RelationProperty>, IEnumerable
```
**VB**
``` VB
Public MustInherit Class RelationProperty
	Inherits VCardProperty
	Implements IEnumerable(Of RelationProperty), IEnumerable
```
**C++**
``` C++
public ref class RelationProperty abstract : public VCardProperty, 
	IEnumerable<RelationProperty^>, IEnumerable
```
**F#**
``` F#
...
type RelationProperty = 
    class
        ...
        interface IEnumerable<RelationProperty>
        interface IEnumerable
    end
```

<table><tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  <a href="e1395eb9-792c-c4d8-ee22-97939a91c58e.md">VCardProperty</a>  →  RelationProperty</td></tr>
<tr><td><strong>Implements</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.collections.generic.ienumerable-1" target="_blank" rel="noopener noreferrer">IEnumerable</a>(RelationProperty), <a href="https://learn.microsoft.com/dotnet/api/system.collections.ienumerable" target="_blank" rel="noopener noreferrer">IEnumerable</a></td></tr>
</table>



## Remarks
vCard properties whose data is encapsulated by RelationProperty objects are in particular the vCard 4.0 properties `RELATED` and `MEMBER`, the vCard 2.1 and vCard 3.0 property `AGENT`, as well as non-standard properties for specifying the name of the spouse (such as `X-SPOUSE`).
...
<td>The data provided by the RelationProperty.</td></tr>
</table>
...
<tr>
<td><a href="a2f86a9e-411f-0041-9fdd-b6eb4b49452e.md">FromGuid</a></td>
<td>Creates a new RelationProperty instance from a <code>Guid</code>.</td></tr>
<tr>
<td><a href="c6a42007-d48d-1cd8-c03f-e93f0e03a10f.md">FromText</a></td>
<td>Creates a new RelationProperty instance from text.</td></tr>
<tr>
<td><a href="2a8488c6-c20f-a96e-e911-262df5b97198.md">FromUri</a></td>
<td>Creates a new RelationProperty instance from an absolute <a href="https://learn.microsoft.com/dotnet/api/system.uri" target="_blank" rel="noopener noreferrer">Uri</a>.</td></tr>
<tr>
<td><a href="5f474450-e7ca-a617-9a2a-24cdb0e1b92a.md">FromVCard</a></td>
<td>Creates a new RelationProperty object from a <a href="23413828-9a4a-2851-b88b-84d0afcb0031.md">VCard</a>.</td></tr>
<tr>
...
<tr>
<td><a href="0fd2a615-6d88-5ccc-e45d-16341b27d310.md">GetVCardPropertyValue</a></td>
...
<tr>
<td><a href="1eb39c6a-b170-78ec-88be-5a95bcde60c6.md">ToString</a></td>
...
<table>
<tr>
<td><a href="5c83af36-d085-f664-32ca-2bb35abf3545.md">ConcatWith(RelationProperty)</a></td>
...
<tr>
<td><a href="efb35da5-3e26-82a0-e3c5-1493d26a693e.md">ContainsGroup(RelationProperty)</a></td>
...
<tr>
<td><a href="11466c87-aadb-04fd-fe3d-7125281eb2af.md">FirstOrNull(RelationProperty)</a></td>
...
<tr>
<td><a href="55518c83-06ae-d0b3-2b9b-248467057638.md">FirstOrNull(RelationProperty)</a></td>
...
<tr>
<td><a href="8b1cf361-d9c0-21a1-9fdd-aa193ca0d6c4.md">FirstOrNullIsMemberOf(RelationProperty)</a></td>
...
<tr>
<td><a href="a45403df-1f64-d22e-1df7-3479a2dd40f7.md">OrderByIndex(RelationProperty)</a></td>
...
<tr>
<td><a href="cd6e33b3-a481-08de-5643-cf1676d60d82.md">OrderByPref(RelationProperty)</a></td>
...
<tr>
<td><a href="458f852f-6b59-c580-a2a0-7ad8ab8c805b.md">PrefOrNull(RelationProperty)</a></td>
...
<tr>
<td><a href="956f934a-929d-76c6-2666-1fe7187245ca.md">PrefOrNull(RelationProperty)</a></td>
...
<tr>
<td><a href="1aaa5a6e-e6a3-6ae0-f17c-f9d05c588160.md">Remove(RelationProperty)</a></td>
...
<tr>
<td><a href="cc654469-216d-291e-83c4-99bccd18bd48.md">Remove(RelationProperty)</a></td>
...
<table>
<tr>
<td><a href="72326ed6-83d2-7d98-b5f2-d635380f22b9.md">IEnumerable.GetEnumerator</a></td>
<td>Returns an enumerator that iterates through a collection.</td></tr>
<tr>
<td><a href="6fcc9436-7a42-abc3-e0c6-42000173be96.md">IEnumerable(RelationProperty).GetEnumerator</a></td>
...
<a href="dd88778d-2741-7f5e-33a2-1ce764d4da37.md">Relations</a>  
<a href="ed536746-8d78-03fa-a6c8-94cc04b1e3c0.md">Members</a>  
