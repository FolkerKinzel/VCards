# AdditionalNames Property


Additional Name(s) (middle name(s)).
...
**VB**
``` VB
Public ReadOnly Property AdditionalNames As ReadOnlyCollection(Of String)
	Get
```
**C++**
``` C++
public:
property ReadOnlyCollection<String^>^ AdditionalNames {
	ReadOnlyCollection<String^>^ get ();
}
```
**F#**
``` F#
member AdditionalNames : ReadOnlyCollection<string> with get
```
