...
**C#**
``` C#
public IEnumerable<TextProperty?>? Notes { get; set; }
```
**VB**
``` VB
Public Property Notes As IEnumerable(Of TextProperty)
	Get
	Set
```
**C++**
``` C++
public:
property IEnumerable<TextProperty^>^ Notes {
...
**F#**
``` F#
member Notes : IEnumerable<TextProperty> with get, set
```
