# Load(String, Encoding) Method


Loads a VCF file and allows to specify the <a href="https://learn.microsoft.com/dotnet/api/system.text.encoding" target="_blank" rel="noopener noreferrer">Encoding</a>.
...
#### Parameters
<dl><dt>  <a href="https://learn.microsoft.com/dotnet/api/system.string" target="_blank" rel="noopener noreferrer">String</a></dt><dd>Absolute or relative path to a VCF file.</dd><dt>  <a href="https://learn.microsoft.com/dotnet/api/system.text.encoding" target="_blank" rel="noopener noreferrer">Encoding</a>  (Optional)</dt><dd>The text encoding to use to read the file or <code>null</code>, to read the file with the standard-compliant text encoding <a href="https://learn.microsoft.com/dotnet/api/system.text.encoding.utf8" target="_blank" rel="noopener noreferrer">UTF8</a>.</dd></dl>
...
<td><em>fileName</em> is <code>null</code>.</td></tr>
<tr>
