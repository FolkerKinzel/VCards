...
namespace Examples
{
    ...
    /// into UTC-offsets to be compatible to older vCard clients when writing vCard 2.1 or vCard 3.0.
    ...
    {
        public bool TryGetUtcOffset(string timeZoneID, out TimeSpan utcOffset)
        {
    ...
    public static class VCardExample
    {
        public static void ReadingAndWritingVCard(string directoryPath)
        {
            ...
            // Converts IANA time zone names to utc-Offsets. (See example implementation above.)
            var tzConverter = new TimeZoneIDConverter();
